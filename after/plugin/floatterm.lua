...
vim.keymap.set('t', '<Space>t', '<C-\\><C-n>:FloatermToggle<CR>', { noremap = true, silent = true })
...
vim.keymap.set('n', '<Leader>tt', [[:FloatermNew --name=myfloat --height=0.8 --width=0.7 --autoclose=2 zsh<CR>]], { noremap = true, silent = true })
